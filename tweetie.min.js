...
'<a href="https://twitter.com/search?q=%23$1&amp;src=hash" target="_blank" title="Search for #$1">#$1</a>').replace(/@([a-zA-Z0-9_]+)/g,'<a href="https://twitter.com/$1" target="_blank" title="$1 on Twitter">@$1</a>')},q=function(g){for(var d=c.template,a="date tweet avatar url retweeted screen_name user_name".split(" "),h=0,b=a.length;h<b;h++)d=d.replace(RegExp("{{"+a[h]+"}}","gi"),g[a[h]]);return d};this.html("<span>Loading...</span>");var n=this;f.getJSON(c.apiPath,{username:c.username,list:c.list,
