...
'<a href="http://twitter.com/search?q=%23$1&amp;src=hash" target="_blank" title="Search for #$1">#$1</a>').replace(/@([a-zA-Z0-9_]+)/g,'<a href="http://twitter.com/$1" target="_blank" title="$1 on Twitter">@$1</a>')},p=function(h){for(var d=c.template,b="date tweet avatar url retweeted screen_name".split(" "),a=0,g=b.length;a<g;a++)d=d.replace(new RegExp("{{"+b[a]+"}}","gi"),h[b[a]]);return d};this.html("<span>Loading...</span>");var m=this;f.getJSON(c.apiPath,{username:c.username,list:c.list,hashtag:c.hashtag,
