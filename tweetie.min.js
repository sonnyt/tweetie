...
var n=this;f.getJSON(c.apiPath,{username:c.username,list_slug:c.list,hashtag:c.hashtag,count:c.count,exclude_replies:c.hideReplies},function(g){n.find("span").fadeOut("fast",function(){n.html('<ul class="'+c.ulClass+'"></ul>');for(var d=0;d<c.count;d++){var a=!1;if(g[d])a=g[d];else if(void 0!==g.statuses&&g.statuses[d])a=g.statuses[d];else break;for(var h=a.user.name,b=a.created_at,b=b.split(" "),b=new Date(Date.parse(b[1]+" "+b[2]+", "+b[5]+" "+b[3]+" UTC")),k="January February March April May June July August September October November December".split(" "),
